...
function validate2() {
    ...
    if (primer_nombre == "Daniel" && segundo_nombre == "Andres" && primer_apellido  == "Lascarro" && segundo_apellido == "Mejia" && tipo_identificacion == "Cedula" && numero_identificacion == "1015992141" && direccion == "Cll 40" && telefono == "3134679310" && correo == "daniellascarro@gmail.com" && crear_usuario == "DanielLascarro" && crear_contraseña == "gorillaz100" && confirmar_contraseña == "gorillaz100") {
        alert("REGISTRO EXITOSO");
        window.location = "login_cliente.html"; // Redirecting to other page.
        return true;
    }
    else {
...
if ( usuario == "DanielLascarro" && contraseña == "gorillaz100" )
{
alert ("INGRESO EXITOSO");
window.location = "perfil_cliente.html"; // Redirecting to other page.
return true;
}
else{
attempt --;// decrementa el contador.
